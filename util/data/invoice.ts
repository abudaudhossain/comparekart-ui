...
export async function getInvoices(params: GetInvoiceParams): Promise<invoiceResponse> {
    try {
        ...
        const response = await clientSideAxios.get(`/billing?${queryParams.toString()}`);
        return {
