...
export async function getMatchingProducts(params: GetParams): Promise<Response> {
    try {
        ...
        const response = await clientSideAxios.get(`/matching-products?${queryParams.toString()}`);
        return {
