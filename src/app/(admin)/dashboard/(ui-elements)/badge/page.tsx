...
export const metadata: Metadata = {
  title: "Next.js Badge | UserManagement - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for UserManagement - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
