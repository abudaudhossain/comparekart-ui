...
export const metadata: Metadata = {
  title: "Next.js Avatars | UserManagement - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for UserManagement - Next.js Tailwind CSS Admin Dashboard Template",
};
