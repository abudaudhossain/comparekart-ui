...
export const metadata: Metadata = {
  title: "Next.js Modals | UserManagement - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for UserManagement - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
