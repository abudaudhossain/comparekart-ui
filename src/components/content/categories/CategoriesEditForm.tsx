...
export default function CategoriesEditForm() {
    ...
    useEffect(() => {
        ...
        const fetchOffer = async () => {
            try {
                const res = await clientSideAxios.get(`/categories/${id}`);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await clientSideAxios.put(`/categories/${id}`, dataToSend, {
                headers: {
        ...
        <div className="max-w-4xl mx-auto p-8 bg-white shadow-xl rounded-3xl mt-12 space-y-8">
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <Input id="slug" value={formData.slug || ""} onChange={(v) => handleChange("slug", v.target.value)} placeholder="Category slug" />
                </div>
                {/* Status */}
                <div>
